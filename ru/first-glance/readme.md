...
Стандартным именем файла для ваших нетленок должно быть: название-фио-00, где **название** - название произведения, **фио** - ваше имя и фамилия, 00 - циферки, обозначающие текущую версию вашей нетленки, которые будут увеличиваться на +1 при каждом экспорте после редактирования.

Стандартным местом размещения экспортированных файлов должен быть **Рабочий стол** вашего компьютера.
...
Нажимаем клавишу **ENTER** и в поле для имени персонажа вводим маленькую букву **в**. Умная программа тут же предложит нам уже известное ей имя персонажа ВИТАЛИК. Можно нажать клавишу **ENTER**, ткнуть в предложенное имя мышкой или взять на себя труд написать это имя буковками, не доверяя искуственному интеллекту.
...
Стандартным именем файла для ваших нетленок должно быть: название-фио-00, где **название** - название произведения, **фио** - ваше имя и фамилия, 00 - циферки, обозначающие текущую версию вашей истории, которые вы должны увеличивать на +1 при каждом экспорте после редактирования.

Стандартным местом размещения экспортированных файлов должен быть **Рабочий стол** вашего компьютера, откуда вы сможете переместить экспортированный файл в любое удобное вам место.
...
Не надо на себя надеяться, некоторые вещи нам не подвластны, например внезапное отключение электричества или перезагрузка компьютера по тем или иным причинам. Если программа будет автоматически сохранять всё написанное вами, то максимум что вы потеряете в критической ситуации - это половину предложения. Поставьте здесь галочку, если она по каким-то причинам тут не стоит.

Укажите папку для сохранения резервных копий. Можете вписать путь к этой папке вручную (не надо так делать) или ткнуть мышкой в символ папки и выбрать / создать новую, специально для этого предназначенную.

Для большей сохранности ваших творений папка для резервных копий должна находиться в облачном хранилище, например Яндекс диск, Облако мейл.ру или аналоги.
...
**Использовать звуки печатной машинки при нажатии клавиш.** Крутая функция. Очень помогает в работе, воодушевляет и поддерживает до тех пор пока социальное окружение не пообещает сжечь напалмом все ваши сценарии до седьмого колена, потому что каждая буковка забивает маленький гвоздик в окружающие вас светлые головы. Оглянитесь, помолитесь и решите сами, ставить галочку или нет.
...
**Подсвечивать текущую строку.** Строка, с который вы в данный момент работаете, будет подсвечена, то есть выделена голубеньким цветом. Очень удобно для редактирования документа или при чтении чужих документов.
