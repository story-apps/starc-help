...
Выскочит небольшое окно **Создать новую историю**. В первых строках сего окна определите **Тип истории**. В нашем случае это будет **Комикс**. Для этого просто кликните в первую строчку и выберите нужный нам **Тип истории**.
...
Сейчас вы должны написать слово **Кадр** и после этого снова нажать клавишу **ENTER**. Нумеровать ничего не нужно, как я уже говорил, программа будет делать это за вас и деликатно подставит номер вот так: **Кадр 1**, а вы переходите к описанию.
...
В зависимости от вашего творческого замысла вы можете использовать эти элементы, которые также будут старательно нумероваться программой. Поэкспериментируйте. Как отменять и возвращать действия вы уже умеете.
...
Позднее у нас могут появиться другие персонажи: Гена, Глаша, Граф и Гуля, то их имена также будут появляться в выпадающем меню, ну а вам придётся трудиться, добавляя к первой букве вторую, чтобы программа угадала чьё же имя вы хотите написать.
...
Выберите в этом окошечке **тип истории "Пьеса"** и введите **Название истории**. Теперь нажмите кнопочку **СОЗДАТЬ**.

Сейчас не время думать об обложке или кратком описании истории, мы делаем самые первые шаги по освоению нового программного продукта, поэтому посмотрите на левое меню интерфейса. Под вкладкой **Пьеса** вы обнаружите разные опции для рабочих материалов, но сейчас нам нужна опция **Сценарий**. Выберите её. Вот ваш выбор: **Пьеса >> Сценарий**.
...
Вводим один из возможных заголовков: **Акт, Действие, Часть** или **Картина**. Пишем **АКТ I**. Точку ставить не надо, а после написания просто нажмите клавишу **ENTER**.
...
Тут всё просто. Слева пишется кто говорит, справа - что говорит, но тут есть очень важные нюансы.

На новой строке вводим **имя персонажа**: **Глафира Батарейкина**. После имени поставьте точку. Клавишу **SHIFT** нажимать не нужно, имя напишется **ЗАГЛАВНЫМИ БУКВАМИ**. Справа от имени вы увидите значок **>>**. Ткните мышкой справа от этого значка и напишите реплику персонажа: **Какой сегодня день чудесный! Погода - просто благодать! И небо цвета голубого.**

Написали? Замечательно. Теперь давайте послушаем, что ответит Глафире её подружка Тася. После того, как вы поставили точку в реплике Глафиры, нажмите клавишу **ENTER** и курсор переместится на новую строку в ожидании ввода имени собеседника Глафиры.

Пишем имя **Тася** и ставим после имени точку. Перемещаем курсор справа от значка **>>** и поясним читателям нашей нетленки эмоциональное состояние Таси с помощью **внутренней ремарки**. Для этого мы поставим левую скобку **(**. Напишем текст ремарки: **восторженно** и поставим правую скобку **)** и после неё точку.

Давайте узнаем, что говорит Тася: **Тася (восторженно). Как раньше, снова вместе мы! (Вздыхает). Ах, где теперь Степан?**

**ВАЖНО!** Следует оговориться, что функционал программы ещё не полный и некоторые функции пока не работают. Все ремарки в тексте пьесы выделяются курсивом, но вы сможете сделать это при редактировании текста в привычной вам программе **Word**.

**Разберёмся с точками.**

Если после имени персонажа сразу идёт реплика, то точка ставится сразу после имени персонажа: **Глафира Батарейкина.** 

Если после имени персонажа идёт ремарка, точка ставится только после правой скобки ремарки: **Тася (восторженно).** В этом случае ремарка пишется с маленькой буквы.

Если реплика персонажа разбивается ремаркой, то такая ремарка заключается в скобки, текст ремарки пишется с большой буквы, а точка ставится после правой скобки **).** **Тася (восторженно). Как раньше, снова вместе мы! (Вздыхает). Ах, где теперь Степан?**

Ну что же, вот и поговорили Глафира с Тасей, теперь пора им делом заняться. Пусть они у нас будут печь пироги. 

После того, как вы поставили точку в последней реплике, нажмите клавишу **ENTER**. Программа программа захочет продолжить диалог, но нам нужно снова ввести внешнюю ремарку. Вы в растерянности: Ах, что же делать?

Не пугайтесь неизведанного, просто посмотрите на верхнюю часть листа, в котором вы всё это пишете. Там вы увидите значки **<<** и **>>** предлагающие вам **отмену и возврат последнего действия**, а справа от эти значков текст **Персонаж**. Нажмите мышкой на слово **Персонаж**.

Выпадет меню с названиями различных блоков текста, а нам сейчас нужен пункт **Описание действия**. Выберите этот пункт.
